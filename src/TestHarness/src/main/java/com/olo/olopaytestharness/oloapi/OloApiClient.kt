...
class OloApiClient(
    ...
    suspend fun submitBasket(paymentMethod: IPaymentMethod, basketId: String, email: String, billingMethod: String, billingSchemeId: Int?): Order {
        ...
        if (billingSchemeId != null) {
            data["billingschemeid"] = billingSchemeId.toString()
        }
