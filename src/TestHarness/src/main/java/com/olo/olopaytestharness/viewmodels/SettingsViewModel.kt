...
class SettingsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val postalCodeRequired =
        MutableLiveData(application.resources.getBoolean(R.bool.postal_code_required))

    val usPostalCodeRequired =
        MutableLiveData(application.resources.getBoolean(R.bool.us_postal_code_required))
