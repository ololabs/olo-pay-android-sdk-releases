...
class SettingsViewModel(
    ...
    private val googlePaySettings: GooglePaySettings
    ...
    //////////////////////////////////////
    val useLoggedInUser = userSettings.useLoggedInUser
    val userEmail = userSettings.userEmail
    val userPassword = userSettings.userPassword
    val savedCardBillingId = userSettings.savedCardBillingId

    //////////////////////////////////////
    // GOOGLE PAY SETTINGS
    //////////////////////////////////////

    val usePayNowGooglePayButton = googlePaySettings.usePayNowGooglePayButton
    val useLineItems = googlePaySettings.useLineItems
    ...
    fun notifySettingsChanged() {
        ...
        userSettings.notifySettingsChanged()
        googlePaySettings.notifySettingsChanged()
    }
        ...
        val Factory: ViewModelProvider.Factory = object: ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(modelClass: Class<T>, extras: CreationExtras): T {
                ...
                return SettingsViewModel(
                    ...
                    UserSettings.getInstance(application.applicationContext),
                    GooglePaySettings.getInstance(application.applicationContext)
                ) as T
            }
        }
    }
