...
class SettingsFragment : DialogFragment() {
    ...
    var settingsType: SettingsType
        get() = enumValueOf(requireArguments().getString("SettingsTypeKey", SettingsType.CreditCard.description))
        set(value) = requireArguments().putString("SettingsTypeKey", value.toString())
    ...
    override fun onResume() {
        ...
        binding.settingsType = settingsType
