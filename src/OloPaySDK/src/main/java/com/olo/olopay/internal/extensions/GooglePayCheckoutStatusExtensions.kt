...
internal fun GooglePayCheckoutStatus.toStripeCheckoutOption() : StripeCheckoutOption {
    return when (this) {
...
internal fun GooglePayCheckoutStatus.toStripePriceStatus() : StripePriceStatus {
    return when (this) {
