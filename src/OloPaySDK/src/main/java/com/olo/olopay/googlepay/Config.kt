...
import com.stripe.android.GooglePayJsonFactory.BillingAddressParameters.Format as StripeGooglePayBillingFormat
...
data class Config @JvmOverloads constructor(
    ...
    enum class AddressFormat(internal val code: String) {
        ...
        internal fun toStripeGooglePayFormat() : StripeGooglePayBillingFormat {
            return when (this) {
                Min -> StripeGooglePayBillingFormat.Min
                Full -> StripeGooglePayBillingFormat.Full
            }
        }
    }
}