...
class CardErrorTypeTests {
    ...
    @Test
    fun from_InvalidCvcStr_To_InvalidCvc() {
        assertEquals(CardErrorType.InvalidCVC, CardErrorType.from(CardErrorType.InvalidCvcStr))
    }

    @Test
    fun from_IncorrectNumberStr_To_IncorrectNumber() {
        assertEquals(CardErrorType.IncorrectNumber, CardErrorType.from(CardErrorType.IncorrectNumberStr))
    }
    ...
    @Test
    fun from_IncorrectCvcStr_To_IncorrectCvc() {
        assertEquals(CardErrorType.IncorrectCVC, CardErrorType.from(CardErrorType.IncorrectCvcStr))
    }
    ...
    @Test
    fun from_IncorrectZipStr_To_IncorrectZip() {
        assertEquals(CardErrorType.IncorrectZip, CardErrorType.from(CardErrorType.IncorrectZipStr))
    }
