...
class CardStateTests {
    ...
    fun onInputChanged_widgetValid_withInvalidFields_stateUpdated() {
        ...
        val state = CardState()
        state.postalCodeEnabled = false
        state.onInputChanged(true, CardBrand.Visa, invalidFields)
    ...
    fun onInputChanged_widgetInvalid_withInvalidFields_stateUpdated() {
        ...
        val state = CardState()
        state.onInputChanged(false, CardBrand.Visa, invalidFields)
    ...
    @Test
    fun onInputChanged_widgetValid_withUnsupportedCardType_stateUpdated() {
        ...
        state.onInputChanged(true, CardBrand.Unknown, invalidFields)
